...
```{r, out.width = "600px", echo=FALSE, fig.cap= "_Fig. 1: GitHub Logo_"}
knitr::include_graphics("github-logo.jpg")
```
...
knitr::include_graphics("branching.png")
```
...
knitr::include_graphics("branching1.png")
```
